...
public class Form_Empleados extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        buttonBadges2 = new com.tecjerez.proyecto_clinica.interfaz.swim.ButtonBadges();
        ...
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            ...
            jTable1.getColumnModel().getColumn(2).setHeaderValue("´Primer apellido");
            jTable1.getColumnModel().getColumn(3).setHeaderValue("Segundo apellido");
            jTable1.getColumnModel().getColumn(4).setHeaderValue("Calle");
            jTable1.getColumnModel().getColumn(5).setHeaderValue("Número casa");
            jTable1.getColumnModel().getColumn(6).setHeaderValue("Colonia");
            jTable1.getColumnModel().getColumn(7).setHeaderValue("CP");
            jTable1.getColumnModel().getColumn(8).setHeaderValue("Número de telefono");
            jTable1.getColumnModel().getColumn(9).setHeaderValue("Puesto");
        }
    ...
    private com.tecjerez.proyecto_clinica.interfaz.swim.ButtonBadges buttonBadges2;
